const APP_ID = '7a23baea19734f39982ceb49a634eed1';
...
let joinAndDisplayLocalStream = async () => {
    document.getElementById('room_name').innerText = CHANNEL
    ...
    let player = `<div class="video-container" id="user-container-${UID}">
                    <div class="username-wrapper"><span id="user_name">${member.name}</span></div>
